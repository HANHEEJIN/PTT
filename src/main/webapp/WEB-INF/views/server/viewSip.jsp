    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">SIP 상세 정보</h1>
            </div>
            <!-- /.container-fluid -->
			...
			<table class="table mb-0" style="width:60%; float: none; margin: 10 auto;">
				...
				<tr>
					<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="sip_id" id="sip_id" value="${SVIEW.svr_id}">
	 					</div>
	 				</td>
					<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="sip_ip" id="sip_ip" value="${SVIEW.svr_ip}">
	 					</div>
	 				</td>
					...
					<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="sip_port" id="sip_port" value="${SVIEW.svr_port}" readonly>
	 					</div>
	 				</td>
	 			<%-- 	<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="sip_type" id="sip_port" value="${SVIEW.svr_type}" readonly>
	 					</div>
	 				</td> --%>
				</tr>
				...
				<tr>
					<td>
						<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/server/listSip.do'">목록</button>
