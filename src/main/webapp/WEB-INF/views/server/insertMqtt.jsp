				...
				<tr>
					<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="mqtt_svr_id" id="mqtt_svr_id">
	 					</div>
	 				</td>
					<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="mqtt_svr_ip" id="mqtt_svr_ip" >
	 					</div>
	 				</td>
					...
					<td> 
						<div class="input-group mb-3 input-group-sm">
							...
							<input type="text" class="form-control" name="mqtt_svr_port" id="mqtt_svr_port" value="1883" readonly>
	 					</div>
	 				</td>
				</tr>
